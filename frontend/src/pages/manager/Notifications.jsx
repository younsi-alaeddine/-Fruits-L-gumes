...
import { Bell, CheckCircle, Clock, Store } from 'lucide-react'
...
function ManagerNotifications() {
  ...
  const loadNotifications = async () => {
    try {
      const managerNotifs = [
        { id: 1, type: 'store', title: 'Alerte stock - Centre-Ville', message: 'Stock d\'oranges faible dans Magasin Centre-Ville', isRead: false, createdAt: '2026-01-20T10:30:00Z', priority: 'high', storeId: 1 },
        { id: 2, type: 'order', title: 'Objectif atteint - Hay Riad', message: 'Magasin Hay Riad a atteint 100% de son objectif mensuel', isRead: false, createdAt: '2026-01-20T09:15:00Z', priority: 'medium', storeId: 2 },
        { id: 3, type: 'employee', title: 'Nouveau employé - Agdal', message: 'Ahmed Benali a été ajouté à l\'équipe du Magasin Agdal', isRead: true, createdAt: '2026-01-19T16:45:00Z', priority: 'low', storeId: 3 },
      ]
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Notifications Manager</h1>
      ...
      <div className="card">
        ...
        <div className="space-y-4">
          {filteredNotifications.map((notif) => (
            <div key={notif.id} className={`border-2 rounded-xl p-4 ${notif.isRead ? 'bg-white border-gray-200' : 'bg-purple-50 border-purple-200'}`}>
